...
>(({ className, children, label, ...props }, ref) => (
  <div className="flex flex-col gap-1.5 w-full">
    ...
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        'flex h-10 w-full items-center justify-between rounded px-3',
        'text-body-md text-on-surface bg-surface-container-low',
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex w-full cursor-default select-none items-center rounded py-2 pl-8 pr-2',
